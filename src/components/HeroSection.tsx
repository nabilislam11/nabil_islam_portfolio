      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <h2 className="text-2xl lg:text-3xl text-muted-foreground mb-6">
              A Passionate <span className="text-primary">MERN Stack Developer</span>
            </h2>
            
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl">
              I build responsive, performance-driven websites and enjoy turning ideas into code. 
              Specializing in modern React applications with beautiful, functional user experiences.
            </p>
          ...
          <div className="flex-1 flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-primary/60 rounded-full animate-star-twinkle" style={{ animationDelay: '1s' }}></div>
              <div className="absolute top-1/2 -left-8 w-4 h-4 bg-primary/40 rounded-full animate-star-twinkle" style={{ animationDelay: '2s' }}></div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 overflow-hidden">
          <div className="flex whitespace-nowrap animate-marquee">
            ...
            <span className="text-lg text-muted-foreground mx-8">INNOVATIVE</span>
            <span className="text-lg text-primary mx-8">•</span>
            <span className="text-lg text-muted-foreground mx-8">PASSIONATE</span>
            <span className="text-lg text-primary mx-8">•</span>
            <span className="text-lg text-muted-foreground mx-8">DEDICATED</span>
            <span className="text-lg text-primary mx-8">•</span>
            <span className="text-lg text-muted-foreground mx-8">CREATIVE</span>
            <span className="text-lg text-primary mx-8">•</span>
            <span className="text-lg text-muted-foreground mx-8">INNOVATIVE</span>
